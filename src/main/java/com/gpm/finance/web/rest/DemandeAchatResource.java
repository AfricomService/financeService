...
import com.gpm.finance.service.DemandeAchatService;
...
/**
 * REST controller for managing {@link com.gpm.finance.domain.DemandeAchat}.
 */
@RestController
@RequestMapping("/api")
public class DemandeAchatResource {
    ...
    private static final String ENTITY_NAME = "financeServiceDemandeAchat";
    ...
    public DemandeAchatResource(DemandeAchatService demandeAchatService, DemandeAchatRepository demandeAchatRepository) {
    ...
    public ResponseEntity<DemandeAchatDTO> createDemandeAchat(@Valid @RequestBody DemandeAchatDTO demandeAchatDTO)
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/demande-achats/{id}")
    public ResponseEntity<DemandeAchatDTO> updateDemandeAchat(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody DemandeAchatDTO demandeAchatDTO
    ) throws URISyntaxException {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/demande-achats/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<DemandeAchatDTO> partialUpdateDemandeAchat(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody DemandeAchatDTO demandeAchatDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<DemandeAchatDTO>> getAllDemandeAchats(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of DemandeAchats");
        Page<DemandeAchatDTO> page = demandeAchatService.findAll(pageable);
    ...
    public ResponseEntity<DemandeAchatDTO> getDemandeAchat(@PathVariable Long id) {
