...
import com.gpm.finance.service.BonCommandeService;
...
/**
 * REST controller for managing {@link com.gpm.finance.domain.BonCommande}.
 */
@RestController
@RequestMapping("/api")
public class BonCommandeResource {
    ...
    private static final String ENTITY_NAME = "financeServiceBonCommande";
