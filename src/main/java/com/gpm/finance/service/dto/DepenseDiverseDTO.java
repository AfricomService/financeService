...
/**
 * A DTO for the {@link com.gpm.finance.domain.DepenseDiverse} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DepenseDiverseDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DepenseDiverseDTO)) {
            return false;
        }

        DepenseDiverseDTO depenseDiverseDTO = (DepenseDiverseDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, depenseDiverseDTO.id);
    }
